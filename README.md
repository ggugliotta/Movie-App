...
<h1 align="center">Welcome to the Flickette API </h1>
...
- My movie API utilizes [render](render.com) to connect with my [API](www.mongodb.com) and [netlify](netlify.com)for the front-end server. View here: [flickette.netlify.app](flickette.netlify.app)
